<template>
  <div class="container">
    ...
    <el-form :inline="true" class="form">
      <el-input v-model="newTodo.content" placeholder="请输入任务内容" style="margin-right: 10px; width: 200px;" />
      <el-date-picker v-model="newTodo.doTime" type="datetime" placeholder="处理时间"
        style="margin-right: 10px; width: 200px;" />

      <el-button type="primary" @click="addTodo" style="margin-left: 5px;">添加任务</el-button>
      <el-switch v-model="onlyUnfinished" active-text="未完成" style="margin-bottom: 0px; margin-left: 20px;"
        @change="() => fetchTodos(1)" />
    </el-form>

    <el-table :data="todoList" stripe style="width: 100%; margin-top: 20px;">
    ...
    <el-pagination class="pagination" v-model:current-page="currentPage" :page-size="pageSize" :total="total"
      ...
      @size-change="(val) => { pageSize = val; fetchTodos(1); }" style="margin-top: 20px; text-align: right;" />
  </div>
</template>
